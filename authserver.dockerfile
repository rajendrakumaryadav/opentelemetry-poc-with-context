...
CMD ["opentelemetry-instrument", "--traces_exporter", "otlp_proto_http", "--metrics_exporter", "console", "--logs_exporter", "console", "--service_name", "auth_server", "python", "user_auth.py"]
